    ...
    <div class="row justify-content-center mt-5" >
      <div class="col-md-6">
        <div class="card card-3 card-0 mb-5">
          <div class="card-body">
            <a href="{{ route('admin_onay') }}"  ><i class="bi bi-circle-square"></i> Onaylanan Başvuruları Görüntüle</a><br><br>
            <p>Bu alanda sadece onaylanan başvurular yer alacaktır. </p>
            <a href="{{ route('admin_onay') }}"  >Görüntüle</a><br><br>
      ...
      <div class="col-md-6">
        <div class="card card-1 card-0 mb-5">
          <div class="card-body">
            <a href="{{ route('admin_red') }}"  ><i class="bi bi-circle-square"></i> Reddedilen Başvuruaları Görüntüle</a><br><br>
            <p>Bu alandaki başvular admin tarafından reddedilen başvurulardır.</p>
            <a href="{{ route('admin_red') }}"  >Görüntüle</a><br><br>
